...
const frequency = {category:'frequency',values:[{ _id: 'daily', name: '1 vez por dia', icon: 'mdiCalendarToday' }, { _id: 'twiceaday', name: '2 veces por dia', icon: 'mdiCalendarRange' }, { _id: 'weekly', name: '1 vez por semana', icon: 'mdiCalendarRange' }, { _id: 'weekly2', name: '2 veces por semana', icon: 'mdiCalendarRange' }]};
