...
const Layout = ({ title = "Title", description = "Description", className, children }) => (
    <div>
        <Menu />
            <MDBCol className="text-white text-center py-5 px-4" style={{ backgroundImage: `url(https://barriodogg.com/wp-content/uploads/2018/11/WEBSITE-WOOD-BACKGROUND.jpg)` }}>
